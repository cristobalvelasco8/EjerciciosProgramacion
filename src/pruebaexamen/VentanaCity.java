...
public class VentanaCity {
	...
	private void cargarActualEnPantalla() {
		if (this.actual != null) {
			...
			this.jtfCif.setText(this.actual.getName());
			this.jtfNombre.setText(this.actual.getPopulation());
		}
	}
	...
	private void cargarActualDesdePantalla() {
		...
		this.actual.setName(jtfCif.getText());
		this.actual.setPopulation(jtfNombre.getText());
	}
	...
	private void initialize() {
		...
		lblNewLabel_2 = new JLabel("Poblacion:");
