...
public class VentanaClientes {
	...
	private void cargarActualEnPantalla() {
		if (this.actual != null) {
			...
			this.jtfName.setText(this.actual.getNombre());
	...
	private void cargarActualDesdePantalla() {
		...
		this.actual.setNombre(jtfName.getText());
		this.actual.setApellidos(jtfApellidos.getText());
		this.jtfLocalidad.setText(this.actual.getLocalidad());
		this.jtfDniNie.setText(this.actual.getDniNie());
		this.jtfLocalidad.setText(this.actual.getEmail());
	}
	...
	private void initialize() {
		...
		frame.getContentPane().add(jtfName, gbc_jtfNombre);
